(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-big")) new core(".slider-big", {
            ...
            navigation: {
                prevEl: ".gallery .slider-navigation__button_prev",
                nextEl: ".gallery .slider-navigation__button_next"
            },
            thumbs: {
                swiper: {
                    el: ".slider",
        ...
        if (document.querySelector(".video__slider ")) new core(".video__slider ", {
            ...
            loop: true,
            navigation: {
                prevEl: ".video .slider-navigation__button_prev",
                nextEl: ".video .slider-navigation__button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.3
        ...
        if (document.querySelector(".revievs__slider")) new core(".revievs__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            autoHeight: true,
            ...
            speed: 800,
            navigation: {
                prevEl: ".revievs .slider-navigation__button_prev",
                nextEl: ".revievs .slider-navigation__button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
