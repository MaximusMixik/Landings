(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-about")) new swiper_core_Swiper(".swiper-about", {
            ...
            pagination: {
                el: ".swiper-about  .navigation__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-about .navigation__button--prev",
                nextEl: ".swiper-about .navigation__button--next"
            },
            breakpoints: {
                500: {
                    slidesPerView: 2.5,
