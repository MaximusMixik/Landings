(() => {
    ...
    function initSliders() {
        let mainSlider;
        let popupSlider;
        if (document.querySelector(".portfolio__slider")) mainSlider = new Swiper(".portfolio__slider", {
        ...
        if (document.querySelector(".popup__slider")) popupSlider = new Swiper(".popup__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (popup) popup.addEventListener("click", (e => {
            if (!e.target.closest(".popup__content") && !e.target.closest(".popup__navigation")) closePopup();
        }));
    }
