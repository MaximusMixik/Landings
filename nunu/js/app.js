(() => {
    ...
    function digitsCounter() {
        function digitsCountersInit(digitsCountersItem) {
            let digitsCounter = digitsCountersItem ? digitsCountersItem : document.querySelector("[data-digits-counter]");
            if (digitsCounter) {
        ...
        function digitsCounterAction(e) {
            const entry = e.detail.entry;
            entry.target;
            if (entry.isIntersecting) digitsCountersInit(entry.target);
        }
